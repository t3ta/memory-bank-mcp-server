...
import { DomainError, DomainErrorCodes } from "../../shared/errors/DomainError.js"; // Added DomainError import
import type { BranchTagIndex as TagIndex } from "@memory-bank/schemas"; // Changed TagIndex to BranchTagIndex and aliased
