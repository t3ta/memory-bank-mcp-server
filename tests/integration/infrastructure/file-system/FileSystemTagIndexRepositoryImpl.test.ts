...
describe('FileSystemTagIndexRepositoryImpl Integration Tests', () => {
  ...
  beforeEach(async () => {
    ...
    branchRepository = new FileSystemBranchMemoryBankRepository(fileSystemService, testEnv.branchRoot);
    globalRepository = new FileSystemGlobalMemoryBankRepository(fileSystemService, testEnv.globalRoot);
  ...
  describe('Branch Tag Index Operations', () => {
    ...
    it('should add document to branch index', async () => {
      ...
      await tagIndexRepository.addDocumentToBranchIndex(BRANCH_INFO, document);
    ...
    it('should remove document from branch index', async () => {
      ...
      await tagIndexRepository.removeDocumentFromBranchIndex(BRANCH_INFO, docPath);
