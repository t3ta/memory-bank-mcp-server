...
/**
 * Unit tests for UpdateTagIndexUseCase
 * 
 * These tests verify that the UpdateTagIndexUseCase correctly implements:
 * - Building tag indices for both global and branch memory banks
 * - Collecting all unique tags from documents
 * - Handling cases with documents that have no tags
 * - Handling missing or inaccessible documents
 * - Supporting full rebuild option
