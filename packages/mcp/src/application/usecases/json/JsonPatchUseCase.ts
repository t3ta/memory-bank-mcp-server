...
import { Rfc6902JsonPatchAdapter } from '../../../domain/jsonpatch/Rfc6902JsonPatchAdapter.js'; // Use rfc6902 adapter
...
export class JsonPatchUseCase {
  ...
  constructor(
    ...
    this.patchService = patchService ?? new Rfc6902JsonPatchAdapter(); // Use rfc6902 adapter as default
  }
