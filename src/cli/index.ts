...
// ===== Legacy Commands =====
// These will eventually be refactored to use the new command structure

// Read Global Document
cli.command(
  'read-global <path>',
...
// Write Global Document
cli.command(
  'write-global <path> [content]',
  ...
  async (argv) => {
    try {
      // Use the shared input reader for consistency
...
cli.command(
  'read-branch <branch> <path>',
  'Read a document from a branch memory bank',
  (yargs) => {
    return yargs
      .positional('branch', {
...
cli.command(
  'write-branch <branch> <path> [content]',
  'Write a document to a branch memory bank',
  (yargs) => {
    return yargs
      .positional('branch', {
        describe: 'Branch name',
...
// Read Core Files
cli.command(
  'read-core-files <branch>',
  'Read all core files from a branch memory bank',
  (yargs) => {
    return yargs
      .positional('branch', {
        describe: 'Branch name',
...
cli.command(
  ...
  'Create a pull request from branch memory bank',
  (yargs) => {
    return yargs
      .positional('branch', {
        describe: 'Branch name',
...
// Register all new-style commands
registerAllCommands(cli);

// ===== CLI Configuration =====
// Add examples and help info
cli
