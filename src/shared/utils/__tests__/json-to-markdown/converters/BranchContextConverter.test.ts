...
import { BranchContextConverter } from '../../../json-to-markdown/converters/BranchContextConverter.js';
import { Tag } from '../../../../../domain/entities/Tag.js';

// テスト用のドキュメント生成関数
function createBranchContextDocument(content: any = { purpose: 'ダミーの目的です。' }): JsonDocument {
