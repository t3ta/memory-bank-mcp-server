...
import { ActiveContextConverter } from '../../../json-to-markdown/converters/ActiveContextConverter.js';
import { Tag } from '../../../../../domain/entities/Tag.js';

// テスト用のドキュメント生成関数
function createActiveContextDocument(content: any = { currentWork: 'ダミーコンテンツ' }): JsonDocument {
