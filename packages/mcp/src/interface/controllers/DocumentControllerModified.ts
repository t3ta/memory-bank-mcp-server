...
// アダプターレイヤーのインポート
import { convertDocumentInputToDomain, convertDomainDocumentToResponse, convertErrorToResponse, createValidationError } from '../../adapters/domain/DocumentControllerAdapter.js';
 ...
 *
 * This controller is an evolution of the original DocumentController with improved:
 * - Adapter layer integration for cleaner separation of concerns
 * - Standardized error handling
 * - Consistent response formats
 * - Better validation for input parameters
 *
 * @deprecated Use this controller instead of the legacy DocumentController
 */
