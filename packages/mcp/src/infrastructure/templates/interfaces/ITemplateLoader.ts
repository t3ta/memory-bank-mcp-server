 ...
 */
import { Language } from '@memory-bank/schemas'; // Removed JsonTemplate alias as it's unused as a value
...
export interface ITemplateLoader {
   ...
   */
  loadJsonTemplate(templateId: string): Promise<JsonDocumentV2>; // Use JsonDocumentV2 type
