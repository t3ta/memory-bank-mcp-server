...
describe('JsonDocument', () => {
  ...
  const branchContextContent = {
    ...
    userStories: [
      { description: 'Test story', completed: false }
    ]
  };
  ...
  describe('modification methods', () => {
    ...
    it('should update path', () => {
      ...
      expect(updatedDocument.lastModified.getTime()).toBeGreaterThanOrEqual(document.lastModified.getTime());
    ...
    it('should update content', () => {
      ...
      const newContent = {
        ...
        userStories: [
          { description: 'Updated story', completed: true }
        ]
      };
