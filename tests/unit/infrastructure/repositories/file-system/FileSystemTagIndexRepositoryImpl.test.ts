/**
 * FileSystemTagIndexRepositoryImpl Unit Tests
 *
 * These tests verify the functionality of the file system-based tag index repository,
 * focusing on building tag indexes and tag-based document searches.
 */
...
import { TAG_INDEX_VERSION } from 'src/schemas/v2/tag-index';
